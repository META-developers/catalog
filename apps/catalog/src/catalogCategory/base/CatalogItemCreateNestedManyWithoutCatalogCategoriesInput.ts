...
@InputType()
class CatalogItemCreateNestedManyWithoutCatalogCategoriesInput {
...
export { CatalogItemCreateNestedManyWithoutCatalogCategoriesInput as CatalogItemCreateNestedManyWithoutCatalogCategoriesInput };

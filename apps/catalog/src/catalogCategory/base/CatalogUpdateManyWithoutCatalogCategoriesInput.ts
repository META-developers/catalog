...
@InputType()
class CatalogUpdateManyWithoutCatalogCategoriesInput {
...
export { CatalogUpdateManyWithoutCatalogCategoriesInput as CatalogUpdateManyWithoutCatalogCategoriesInput };

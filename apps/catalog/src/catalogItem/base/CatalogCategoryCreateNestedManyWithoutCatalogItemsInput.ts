...
@InputType()
class CatalogCategoryCreateNestedManyWithoutCatalogItemsInput {
...
export { CatalogCategoryCreateNestedManyWithoutCatalogItemsInput as CatalogCategoryCreateNestedManyWithoutCatalogItemsInput };

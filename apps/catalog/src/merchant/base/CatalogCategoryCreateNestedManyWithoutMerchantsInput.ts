...
@InputType()
class CatalogCategoryCreateNestedManyWithoutMerchantsInput {
...
export { CatalogCategoryCreateNestedManyWithoutMerchantsInput as CatalogCategoryCreateNestedManyWithoutMerchantsInput };
